...
loop:
	jmp loop	; Define a label, "loop", that will allow ; us to jump back to it, forever.
...
times 510-($-$$) db 0	; When compiled, our program must fit into 512 bytes,
			...
			; $ is a placeholder for cuurent address
			; $$ is a placeholder for the beginning address of the current section
